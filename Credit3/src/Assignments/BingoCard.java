...
public class BingoCard
{
	...
	{	
		...
		System.out.print(B2 + "\t" + I2 + "\t" + N2 + "\t" + G2 + "\t" + O2 + "\n\n"); // prints the second row of numbers
		System.out.print(B3 + "\t" + I3 + "\tFREE\t" + G3 + "\t" + O3 + "\n\n"); // prints the third row of numbers
		System.out.print(B4 + "\t" + I4 + "\t" + N4 + "\t" + G4 + "\t" + O4 + "\n\n"); // prints the fourth row of numbers
		System.out.print(B5 + "\t" + I5 + "\t" + N5 + "\t" + G5 + "\t" + O5); // prints the fifth row of numbers
	}
